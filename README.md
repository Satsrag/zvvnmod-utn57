...
独立的 ZVVNMOD ↔ UTN #57 Rust 库。当前第一步只包含：

- 用户名称表的可重复代码生成；
- ZVVNMOD code 的语义化 Rust 常量；
- 多 written-shape 合并后的 `ZvvnmodShape`；
- `CODE_TO_SHAPE`；
- `Shape → 全部 ZVVNMOD aliases` Map；
- FVS1/FVS2/FVS3/MVS 控制常量。
